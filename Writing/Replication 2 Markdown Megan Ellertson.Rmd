...
$$ols(treat) = age + age^2 + age^3 + educ + educ^2 + marr + nodegree + black + 
hisp + re74 + re74^2 + re75 + re75^2 + u74 + u75 + \epsilon$$
...
# 2
The first differencing compares the outcomes of the trimmed data provides the ATE output. This provides the first difference.  
```{r echo = TRUE}
nsw_dw_cpscontrol_logit %>% 
  filter(treat == 1)
